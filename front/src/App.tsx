...
const IMAGE_PATH = './assets/data/street.jpeg';
const IMAGE_EMBEDDING = './assets/data/street_embedding.npy';
const MODEL_DIR = './model/sam_vit_h_4b8939.prompt-mask-quantized.onnx';
